...
const formReducerFn=(latestState,action)=>{
    if(action.type==='TITLE'){
        ...
        return {userTitle:"",userDate:"",userAmout:""}
    }
}
...
// second approch through useState to reducer it alternativ to useState
    const [formReducer,setFormReducer]=useReducer(formReducerFn,{userTitle:"",userDate:"",userAmout:""})
...
const subscription={title:formReducer.userTitle, amount:formReducer.userAmout, date: new Date(formReducer.userDate)}
